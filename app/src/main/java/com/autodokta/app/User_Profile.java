...
public class User_Profile extends AppCompatActivity {
    ...
    TextView fullname, email, username, firstname, lastname, address, phonenumber;
    String sprofileimage,sfirstname,slastname,snumber,saddress,susername;

    EditText fnameeText, lnameeText, emaileText, usernameeText, addresseText, numbereText;
