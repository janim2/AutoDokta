...
import com.autodokta.app.Adapters.ProfileListAdapter;
...
public class User_Profile extends AppCompatActivity {
    ...
    private ArrayList<ProfileList> movieList;
...
//
    ...
    private void init() {
        ...
        rvMovies = findViewById(R.id.rv_profile);
    }

    private void generateData() {
        movieList.add(new ProfileList("My Adverts"));
        movieList.add(new ProfileList("Settings"));
        movieList.add(new ProfileList("Membership"));
        movieList.add(new ProfileList("Invite and earn"));
        movieList.add(new ProfileList("Logout"));
//        adapter.notifyDataSetChanged();
    ...
    private void setData() {
        ...
        rvMovies.setAdapter(new ProfileListAdapter(this, movieList));
    }
